...
function migration_0_18_37.global()
end

function migration_0_18_37.player_table(player, player_table)
    player_table.factory.valid = nil
    player_table.archive.valid = nil
end

function migration_0_18_37.subfactory(player, subfactory)
    if not subfactory.valid then Factory.remove(subfactory.parent, subfactory) end
