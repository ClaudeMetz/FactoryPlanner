...
function create_label_element(table, width_remaining, subfactory, selected)
    ...
    if button_width > width_remaining then
        ...
        ui_util.add_tutorial_tooltip(game.get_player(table.player_index), button, nil, "subfactory", false, false)
...
function create_sprite_button(table, name, subfactory)
    ...
    local player = game.get_player(table.player_index)
    if tooltip == "" then ui_util.add_tutorial_tooltip(player, button, nil, "subfactory", false, false)
    else ui_util.add_tutorial_tooltip(player, button, nil, "subfactory", true, false) end
