...
function view_state.generate_metadata(player)
    ...
    local throughput = defaults.get(player, "belts").proto.throughput
    local throughput_divisor = (belts_or_lanes == "belts") and throughput or (throughput / 2)
    local default_cargo_wagon = defaults.get(player, "wagons", "cargo-wagon").proto
    local default_fluid_wagon = defaults.get(player, "wagons", "fluid-wagon").proto
...
function view_state.rebuild_state(player)
    ...
    local belt_proto = defaults.get(player, "belts").proto
    local default_cargo_wagon = defaults.get(player, "wagons", "cargo-wagon").proto
    local default_fluid_wagon = defaults.get(player, "wagons", "fluid-wagon").proto
