...
function matrix_engine.run_matrix_solver(factory_data, check_linear_dependence)
    ...
    for _, item in ipairs(structures.class.list(top_floor_aggregate.Product, false)) do
        structures.class.add(total, item)
    end
    for _, item in ipairs(structures.class.list(top_floor_aggregate.Byproduct, false)) do
        structures.class.add(total, item)
    end
    for _, item in ipairs(structures.class.list(top_floor_aggregate.Ingredient, false)) do
    ...
    for _, item in ipairs(structures.class.list(total, false)) do
